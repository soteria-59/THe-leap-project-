    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400">Issue completion certificates.</p>
        </div>
        <div className="flex gap-3">
            ...
            >
                ...
                <span className="hidden sm:inline">Email Eligible</span>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6">
        <div className="bg-white dark:bg-slate-800 p-4 md:p-6 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700">
             <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
                 <div className="p-2 sm:p-3 bg-green-100 dark:bg-green-900/30 text-green-600 rounded-lg shrink-0">
                     <CheckCircle2 className="w-5 h-5 sm:w-6 sm:h-6" />
                 </div>
                 <div className="min-w-0">
                     <p className="text-xs sm:text-sm font-medium text-slate-500 dark:text-slate-400 truncate">Eligible</p>
                     <p className="text-xl sm:text-2xl font-bold text-slate-900 dark:text-white">{eligible.length}</p>
                 </div>
             </div>
        </div>
        <div className="bg-white dark:bg-slate-800 p-4 md:p-6 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700">
             <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
                 <div className="p-2 sm:p-3 bg-red-100 dark:bg-red-900/30 text-red-600 rounded-lg shrink-0">
                     <XCircle className="w-5 h-5 sm:w-6 sm:h-6" />
                 </div>
                 <div className="min-w-0">
                     <p className="text-xs sm:text-sm font-medium text-slate-500 dark:text-slate-400 truncate">Pending</p>
                     <p className="text-xl sm:text-2xl font-bold text-slate-900 dark:text-white">{ineligible.length}</p>
                 </div>
             </div>
        </div>
      </div>
